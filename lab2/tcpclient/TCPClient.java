...
public class TCPClient {
	 ...
	 * @param statusLabel label that displays connection status in gui
	 * @param recMessages textarea that displays all received messages in gui
	 */
